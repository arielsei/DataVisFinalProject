    ...
    //Width and height
			...
			var toggleBackButton = function() {
				...
				if (hidden) {
                    ...
                    if (rectWidth < (document.getElementById('descriptionsOption1').offsetWidth - 25))
                        backButton.select("rect").attr("width", rectWidth);
                    else
                        backButton.select("rect").attr("width",(document.getElementById('descriptionsOption1').offsetWidth - 50));
